...
public class RightTriangle extends Polygon
{
    ...
    public RightTriangle(Point pointRightAngle, int base, int height, Color color, boolean filled)
    {
        ...
        this.location[0] = new Point(pointRightAngle.x, pointRightAngle.y);
        this.location[1] = new Point(pointRightAngle.x + base, pointRightAngle.y);
        this.location[2] = new Point(pointRightAngle.x, pointRightAngle.y + height);
