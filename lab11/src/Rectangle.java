...
public class Rectangle extends Polygon
{
    ...
    public Rectangle(Point center, int width, int height, Color color, boolean filled)
    {
        ...
        int asd = width / 2;
        int dsa = height / 2;
        location[0] = new Point(center.x + asd, center.y + dsa);
        location[1] = new Point(center.x + asd, center.y - dsa);
        location[2] = new Point(center.x - asd, center.y - dsa);
        location[3] = new Point(center.x - asd, center.y + dsa);
