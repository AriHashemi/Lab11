...
public class Oval extends Shape implements Drawable
{
    ...
    public void draw(Graphics graphics)
    {
        ...
        if(this.isFilled()) 
        {
            graphics.fillOval(this.location[0].x - diameter1 / 2, this.location[0].y 
                    - diameter2 / 2, diameter1, diameter2);
        } 
        
        else 
        {
            graphics.drawOval(this.location[0].x - diameter1 / 2, this.location[0].y
                    - diameter2/ 2, diameter1, diameter2);
        }
    }
}
