...
public class OvalTestOfficial
{
    ...
    public void testOvalConstructorPoint()
    {
        ...
        // TODO: implement this.
        Point[] ovalOneTest = o1.getLocation();
        Point[] ovalTwoTest = o2.getLocation();
        Point[] circleOneTest = c1.getLocation();
        Point[] circleTwoTest = c2.getLocation();
        
        Assert.assertEquals("Location is not what was expected", new Point(100, 100), ovalOneTest[0]);
        Assert.assertEquals("Location is not what was expected", new Point(100, 100), ovalTwoTest[0]);
        Assert.assertEquals("Location is not what was expected", new Point(200, 200), circleOneTest[0]);
        Assert.assertEquals("Location is not what was expected", new Point(200, 200), circleTwoTest[0]);
